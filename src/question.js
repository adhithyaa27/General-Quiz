const questions = [
  ...
  
    {
      ...
      options: [
        { id: 0, text: "JavaScript", isCorrect : true}, // t
    ...
    },
    {
      ...
      options: [
        ...
        { id: 1, text: "Internal storage of the component.",  isCorrect : true }, // t
    ...
    
    {
      ...
      options: [
        { id: 0, text: " Pair of current state and function updating it",  isCorrect :true },  //t
